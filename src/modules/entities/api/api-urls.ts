...
export const TE_DIAGNOSTICS_DATA: string = `http://localhost:8087/entities/technologies/diagnostics/thousandeyes/`;
export const TE_TRACERT_DIAGNOSTICS_DATA: string = `http://localhost:8087/entities/technologies/tracertDiagnostics/thousandeyes/`;
